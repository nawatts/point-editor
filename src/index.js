...
const ConnectedPlacePointMessage = connect(({ dispatch }) => ({ dispatch }))(PlacePointMessage);
// eslint-disable-next-line max-len
const ConnectedLabelPointDialog = connect(({ dispatch, points }) => ({ dispatch, points }))(LabelPointDialog);
